...
*
* \funcusage
*  \snippet BUZ_SUT.c usage_BUZ_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet BUZ_SUT.c usage_BUZ_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet BUZ_SUT.c usage_BUZ_Read  
*******************************************************************************/
uint8 BUZ_Read(void)
{
...
* preferred BUZ_Read() API because the 
* BUZ_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet BUZ_SUT.c usage_BUZ_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: BUZ_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use BUZ_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - BUZ_0_INTR       (First pin in the list)
    *  - BUZ_1_INTR       (Second pin in the list)
    *  - ...
    *  - BUZ_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet BUZ_SUT.c usage_BUZ_SetInterruptMode
    *******************************************************************************/
    void BUZ_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & BUZ_0_INTR) != 0u) 
		{ 
			 BUZ_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet BUZ_SUT.c usage_BUZ_ClearInterrupt
    *******************************************************************************/
