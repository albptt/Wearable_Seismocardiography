...
uint8  Timer_3_ReadPeriod(void) ;
void    Timer_3_WritePeriod(uint8 period) ;
uint8  Timer_3_ReadCounter(void) ;
void    Timer_3_WriteCounter(uint8 counter) ;
uint8  Timer_3_ReadCapture(void) ;
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer_3_CONTROL             (* (reg8 *) Timer_3_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Timer_3_CAPTURE_LSB         (* (reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer_3_CAPTURE_LSB_PTR       ((reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer_3_PERIOD_LSB          (* (reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer_3_PERIOD_LSB_PTR        ((reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer_3_COUNTER_LSB         (* (reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Timer_3_COUNTER_LSB_PTR       ((reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
    #elif(Timer_3_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Timer_3_CAPTURE_LSB         (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Timer_3_CAPTURE_LSB_PTR       ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Timer_3_PERIOD_LSB          (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Timer_3_PERIOD_LSB_PTR        ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Timer_3_COUNTER_LSB         (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
            #define Timer_3_COUNTER_LSB_PTR       ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Timer_3_CAPTURE_LSB         (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Timer_3_CAPTURE_LSB_PTR       ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Timer_3_PERIOD_LSB          (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Timer_3_PERIOD_LSB_PTR        ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Timer_3_COUNTER_LSB         (* (reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
            #define Timer_3_COUNTER_LSB_PTR       ((reg16 *) Timer_3_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Timer_3_Resolution <= 24u)/* 24-bit Timer */
        #define Timer_3_CAPTURE_LSB         (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer_3_CAPTURE_LSB_PTR       ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer_3_PERIOD_LSB          (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer_3_PERIOD_LSB_PTR        ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer_3_COUNTER_LSB         (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Timer_3_COUNTER_LSB_PTR       ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Timer_3_CAPTURE_LSB         (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Timer_3_CAPTURE_LSB_PTR       ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Timer_3_PERIOD_LSB          (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Timer_3_PERIOD_LSB_PTR        ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Timer_3_COUNTER_LSB         (* (reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
            #define Timer_3_COUNTER_LSB_PTR       ((reg32 *) Timer_3_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Timer_3_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timer_3_TimerUDB_sT8_timerdp_u0__A0_REG )
